...
public function main() {
	...
	$nome_supervisor = array('ANTONIA','TAMIRIS','KATILA','JANAINA','ALOISIO','OSMAR','ALEX','NATASHA');
	...
	echo json_encode(array("vendas"=>$result,"supervisor"=>$sort));
}
